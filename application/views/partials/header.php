            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:#393b59">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#" ><h3 id = "logo" style="color: white">Spark Tec</h3></a>
                    ...
                    <div id="navbar-collapse" class="collapse navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a id="user-profile" href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo base_url('assets/img/emp.jpg' )?>" class="img-responsive img-thumbnail img-circle"><?php echo($this->session->userdata('username'))."admin"?></a>
